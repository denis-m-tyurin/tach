...
const char settings_min_rpm_str[] PROGMEM = "ÌÈÍ. ÎÁÎĞÎÒÎÂ";
...
{	
	...
	switch (event)
	{
		...
		case TACH_EVENT_REDRAW_SCREEN:
			snprintf(pData->out_buf, DISPLAY_LINE_SIZE+1, (pData->view_mode == 1 ? "   %u îá/ìèí" : "   <%u> îá/ìèí"), pData->tmp_min_rpm_setting);
