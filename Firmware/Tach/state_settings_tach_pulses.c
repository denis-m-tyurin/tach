...
const char settings_tach_pulses_str[] PROGMEM = "»Ãœ”À‹—Œ¬/Œ¡Œ–Œ“";
...
{	
	...
	switch (event)
	{
		...
		case TACH_EVENT_REDRAW_SCREEN:
			snprintf(pData->out_buf, DISPLAY_LINE_SIZE+1, (pData->view_mode == 1 ? "%u :%u Ó·/Ï" : "<%u> :%u Ó·/Ï"), pData->tmp_pulses_setting, tach_monitor_get_rpm());
